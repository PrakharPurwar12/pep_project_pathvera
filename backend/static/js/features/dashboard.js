...
import { hideLoading, showLoading } from "../core/ui.js";

export function initDashboard() {
    const loadingTarget = document.getElementById("insightsToggle");
...
function loadCurrentUserAnalysis() {
    ...
    if (!hasResumeUploaded(currentUser)) return null;
    return readAnalysisForUser(currentUser);
}
